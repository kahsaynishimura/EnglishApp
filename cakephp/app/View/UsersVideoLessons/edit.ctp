...
<?php echo $this->Form->create('UsersVideoLesson'); ?>
	<fieldset>
		<legend><?php echo __('Edit Users Video Lesson'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UsersVideoLesson.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('UsersVideoLesson.id')))); ?></li>
