<div class="configurations index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $configuration['Configuration']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $configuration['Configuration']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
