...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Html->link(__('List Exercises'), array('action' => 'index', $exercise['Lesson']['id'])); ?> </li>
        <li><?php echo $this->Html->link(__('List Speech Scripts'), array('controller' => 'speech_scripts', 'action' => 'index', $exercise['Exercise']['id'])); ?> </li>
        <li><?php echo $this->Html->link(__('New Speech Script'), array('controller' => 'speech_scripts', 'action' => 'add', $exercise['Exercise']['lesson_id'])); ?> </li>
    </ul>
</div>
<div class="related">
    ...
    <div class="actions">
        <ul>
            <li><?php echo $this->Html->link(__('New Speech Script'), array('controller' => 'speech_scripts', 'action' => 'add', $exercise['Lesson']['id'])); ?> </li>
        </ul>
    </div>
</div>
